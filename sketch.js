...
function fruit1(){
var fruit1=createSprite(Math.round(random(5,windowWidth-5)),0,10,10);
...
function fruit2(){
var fruit2=createSprite(Math.round(random(5,windowWidth-5)),0,10,10);
...
function fruit3(){
var fruit3=createSprite(Math.round(random(5,windowWidth-5)),0,10,10);
...
function fruit4(){
var fruit4=createSprite(Math.round(random(5,windowWidth-5)),0,10,10);
...
//same for aliens
function alien1(){
  var alien1=createSprite(Math.round(random(5,windowWidth-5)),0,10,10);
...
function alien2(){
  var alien2=createSprite(Math.round(random(5,windowWidth-55)),0,10,10);
